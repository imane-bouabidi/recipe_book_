    ...
    <div id="header" class="header">
        <div class="wrap">
            ...
            <nav id="top" class="top-nav">
                ...
                <div class="social">
                    <a href="/feed/" title="RSS" target="_blank" rel="noopener">
                    ...
                    <a href="https://twitter.com/damn_delicious" title="Twitter" target="_blank" rel="noopener">
                        <span class="fa-stack fa-lg">
                            <i class="fa fa-circle fa-stack-2x"></i>
    ...
    <div class="wrap">
        <div id="page_wrap" class="container row">
            <div class="post-content">
                ...
                <div id="recipe"></div>
                <div id="wprm-recipe-container-36041" class="wprm-recipe-container" data-recipe-id="36041"
                    data-servings="4">
                    <div class="wprm-recipe wprm-recipe-template-custom">
                        <div class="wprm-recipe-template-custom-container">
                            <div class="wprm-recipe-template-custom-body">
                                <div class="wprm-recipe-ingredients-container wprm-recipe-36041-ingredients-container wprm-block-text-normal wprm-ingredient-style-regular wprm-recipe-images-before"
                                    data-recipe="36041" data-servings="4">
                                    <h3 class="wprm-recipe-header wprm-recipe-ingredients-header wprm-block-text-uppercase wprm-align-left wprm-header-decoration-none"
                                        style="">Details</h3>
